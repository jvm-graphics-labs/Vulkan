...
//
//        // Vertex buffer
//        if (vertexBuffer.buffer.isInvalid() || vertexCount != drawData.totalVtxCount) {
//            vertexBuffer.unmap()
//            vertexBuffer.destroy()
...
//
//        // Index buffer
//        if (indexBuffer.buffer.isInvalid() || indexCount < drawData.totalIdxCount) {
//            indexBuffer.unmap()
//            indexBuffer.destroy()
...
//            bindIndexBuffer(indexBuffer.buffer, VkDeviceSize(0), VkIndexType.UINT16)
//
