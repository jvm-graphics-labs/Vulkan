...
//        var format = VkFormat.R8G8B8A8_UNORM
//
...
//                    layerCount = 1
//                }
//                it.imageExtent.width = tex2D[i].extent().x // TODO BUG
//                it.imageExtent.height = tex2D[i].extent().y
...
//
//            device.getBufferMemoryRequirements(texture.image, memReqs)
//
//            memAllocInfo.allocationSize = memReqs.size
...
//
//        shaderStages[0].loadShader("shaders/texture/texture.vert.spv", VkShaderStage.VERTEX_BIT)
//        shaderStages[1].loadShader("shaders/texture/texture.frag.spv", VkShaderStage.FRAGMENT_BIT)
//
...
//        // Vertex shader
//        uboVS.projection put glm.perspective(60f.rad, size.aspect, 0.001f, 256f)
