        ...
        for (i in drawCmdBuffers.indices) {
            ...
            drawCmdBuffers[i].apply {
                ...
                if (displaySkybox) {
                    ...
                    bindIndexBuffer(models.skybox.indices.buffer, 0, VkIndexType.UINT32)
                ...
                bindIndexBuffer(models.objects[models.objectIndex].indices.buffer, 0, VkIndexType.UINT32)
