...
//                bindIndexBuffer(models.environment.indices.buffer, VkDeviceSize(0), VkIndexType.UINT32)
...
//        particlesData.mappedMemory = device.mapMemory(particlesData.memory, VkDeviceSize(0), particlesSize)
//    }
//
//    fun updateParticles() {
//
