...
//
//        val attachments = it.vkImageViewBufferOf(offscreenPass.color.view, offscreenPass.depth.view)
//
...
//        offscreenPass.descriptor = vk.DescriptorImageInfo {
...
//        }
//        val renderPassBeginInfo = vk.RenderPassBeginInfo {
//            renderPass = this@OffscreenRendering.renderPass
//            renderArea.offset(0)
...
//                    bindIndexBuffer(models.quad.indices.buffer, VkDeviceSize(0), VkIndexType.UINT32)
...
//                bindIndexBuffer(models.plane.indices.buffer, VkDeviceSize(0), VkIndexType.UINT32)
...
//                0, 1, VkFormat.R32G32_SFLOAT, Vec3.size,                            // Location 1: UV
//                0, 2, VkFormat.R32G32B32_SFLOAT, Vec3.size + Vec2.size,     // Location 2: Color
//                0, 3, VkFormat.R32G32B32_SFLOAT, Vec3.size * 2 + Vec2.size) // Location 3: Normal
//
...
//        }
//        val pipelineCI = vk.GraphicsPipelineCreateInfo(pipelineLayouts.textured, renderPass)
//                .also {
...
//                }
//        pipelines.debug = device.createGraphicsPipelines(pipelineCache, pipelineCI)
//
//        // Mirror
...
//        pipelines.mirror = device.createGraphicsPipelines(pipelineCache, pipelineCI)
//
//        // Flip culling
...
//        pipelines.shaded = device.createGraphicsPipelines(pipelineCache, pipelineCI)
//        // Offscreen
//        // Flip culling
//        rasterizationState.cullMode = VkCullMode.FRONT_BIT.i
//        pipelineCI.renderPass = offscreenPass.renderPass
//        pipelines.shadedOffscreen = device.createGraphicsPipelines(pipelineCache, pipelineCI)
//    }
//
...
//        // Mesh
//        uboShared.projection = glm.perspective(60f.rad, size.aspect, 0.1f, 256f)
//        val viewMatrix = glm.translate(Mat4(1f), Vec3(0f, 0f, zoom))
//
//        uboShared.model = viewMatrix * glm.translate(Mat4(1f), cameraPos)
//                .rotateAssign(rotation.x.rad, 1f, 0f, 0f)
//                .rotateAssign((rotation.y + meshRot.y).rad, 0f, 1f, 0f)
//                .rotateAssign(rotation.z.rad, 0f, 0f, 1f)
//
//        uboShared.model = glm.translate(uboShared.model, meshPos)
//
//        uboShared to uniformBuffers.vsShared.mapped
//
//        // Mirror
//        uboShared.model = viewMatrix * glm.translate(Mat4(1f), cameraPos)
//                .rotateAssign(rotation.x.rad, 1f, 0f, 0f)
...
//                .rotateAssign(rotation.z.rad, 0f, 0f, 1f)
//
//        uboShared to uniformBuffers.vsMirror.mapped
//
//        // Debug quad
//        uboShared.projection = glm.ortho(4f, 0f, 0f, 4f * size.aspect, -1f, 1f)
//        uboShared.model = glm.translate(Mat4(1f), 0f, 0f, 0f)
//
//        uboShared to uniformBuffers.vsDebugQuad.mapped
//    }
//
//    fun updateUniformBufferOffscreen() {
//
//        uboShared.projection = glm.perspective(60f.rad, size.aspect, 0.1f, 256f)
...
//                .rotateAssign(rotation.z.rad, 0f, 0f, 1f)
//
//        uboShared.model = glm.scale(uboShared.model, 1f, -1f, 1f)
//        uboShared.model = glm.translate(uboShared.model, meshPos)
//
//        uboShared to uniformBuffers.vsOffScreen.mapped
//    }
//
//    fun draw() {
//
//        super.prepareFrame()
//
//        /*  The scene render command buffer has to wait for the offscreen rendering to be finished before we can use
//            the framebuffer color image for sampling during final rendering
//            To ensure this we use a dedicated offscreen synchronization semaphore that will be signaled when offscreen
...
//        submitInfo.waitSemaphore = semaphores.presentComplete
//        // Signal ready with offscreen semaphore
//        submitInfo.signalSemaphore = offscreenPass.semaphore
//
//        // Submit work
//        submitInfo.commandBuffer = offscreenPass.commandBuffer
//        queue submit submitInfo
//
//        // Scene rendering
//
//        // Wait for offscreen semaphore
//        submitInfo.waitSemaphore = offscreenPass.semaphore
//        // Signal ready with render complete semaphpre
//        submitInfo.signalSemaphore = semaphores.renderComplete
//
//        // Submit work
