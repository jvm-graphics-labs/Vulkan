...
//
//        val attachments = appBuffer.longBuffer(5)
//
...
//            frameBuffers += device createFramebuffer frameBufferCreateInfo
//        }
//    }
//
...
//                    bindIndexBuffer(models.scene.indices.buffer, 0, VkIndexType.UINT32)
...
//                    bindIndexBuffer(models.transparent.indices.buffer, 0, VkIndexType.UINT32)
...
//        val texDescriptorPosition = vk.DescriptorImageInfo(NULL, attachments.position.view, VkImageLayout.SHADER_READ_ONLY_OPTIMAL)
//
//        val texDescriptorNormal = vk.DescriptorImageInfo(NULL, attachments.normal.view, VkImageLayout.SHADER_READ_ONLY_OPTIMAL)
//
//        val texDescriptorAlbedo = vk.DescriptorImageInfo(NULL, attachments.albedo.view, VkImageLayout.SHADER_READ_ONLY_OPTIMAL)
//
